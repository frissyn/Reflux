javascript:(function() {
    ...
    if (p1 && p2) {
        ...
        if (go) {
            ...
            var target = document.getElementsByClassName("jsx-3593981321")[0];
            
            style.setAttribute("id", "reflux-theme");
            style.appendChild(document.createTextNode(`!css!`));
            
            target.insertAdjacentHTML("afterend", `
            <a id="reflux-display" class="jsx-3593981321" target="_blank" href="//reflux.repl.co/">
                <span class="jsx-3593981321 sidebar-layout-nav-item-icon">
                ...
                <div class="jsx-3593981321">Reflux</div>
                <div class="jsx-3593981321 beta-label">
